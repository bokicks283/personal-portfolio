...
export default function Badge({ text, className, descriptionText, type, key, animation }: BadgeProps) {
  ...
  return (
    <span key={key} className={`badge ${className}`} onMouseEnter={onEnter} onAnimationEnd={onAnimEnd}>
      {text}
    </span>
  )
}
